      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-neutral-600 max-w-md">
              Visualize your code with automatic UML diagrams. Connect with
              GitHub, select repositories, and generate diagrams to better
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  ...
                  className="text-base text-neutral-600 hover:text-primary-600 transition-colors inline-flex items-center"
                >
                  <svg
        ...
        <div className="mt-12 pt-8 border-t border-neutral-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-500 text-sm">
            © {currentYear} UMLCraft. All rights reserved.
          </p>
